...
Before you create a new issue, please do a search in [open issues](https://github.com/ks6088ts/.github/issues) to see if the issue or feature request has already been filed.

Be sure to scan through the [issues](https://github.com/ks6088ts/.github/issues?q=is%3Aissue%20state%3Aopen).
...
- Please refer to the article on [creating pull requests](https://github.com/ks6088ts/.github/wiki/How-to-Contribute#pull-requests) and contributing to this project.
...
If you are interested in writing code to fix issues, please see [How to Contribute](https://github.com/ks6088ts/.github/wiki/How-to-Contribute) in the wiki.
